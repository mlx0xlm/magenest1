...
//            $attributeGroupId = $eavSetup->getDefaultAttributeGroupId(\Magento\Catalog\Model\Product::ENTITY);
//            $eavSetup->addAttribute(
//                Product::ENTITY,
//                'sale_agent_id',
//                [
...
//                    'system' => 0,
//                ]);
//            $attribute = $this->config->getAttribute(\Magento\Catalog\Model\Product::ENTITY, 'sale_agent_id');
//            $attribute->setData('attribute_set_id', $attributeSetId);
//            $attribute->setData('attribute_group_id', $attributeGroupId);
//            $attribute->setData('used_in_forms', [
//                'adminhtml_customer',
